...
function ToolDetails() {
    ...
    function decreaseQuantity() {
        ...
        if (!isNaN(currentValue) && currentValue > 1) {
            ...
            setQantity(input.value)
            setTotalPrice(tool.description.basePrice * input.value)
        }
    }
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex flex-col align-center text-center items-center space-x-2 justify-around mt-8 bg-gray-100 py-3 h-[300px] lg:flex-row lg:h-[200px]">
                <div className="flex flex-col gap-4 h-[82px]">
                    ...
                    <p>Deposit: <span className="font-bold">{tool.description.basePrice / 5} € </span></p>
                </div>
                <div className="flex flex-col text-center gap-3 h-[82px]">
                    <p>Quantity: </p>
                    <div className="flex gap-1 w-[150px]">
                        <button
                            className="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-1 px-3 rounded focus:outline-none focus:ring-2 focus:ring-red-500"
                            type="button"
                ...
                <div className="flex flex-col gap-2 text-center">
                    <p>Total rent price: <span className="font-bold"> {totalPrice} € </span></p>
                    <Link to={"/booking/" + id + "?quantity=" + quantity}  className="bg-red-500 text-white rounded-[25px] border border-red-500 hover:border-black ml-2 px-5 py-3 font-medium">Book reservation</Link>
                </div>
            </div>
        </div>
    );
