      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          >
            ...
            {formData.toolType &&
              toolTypes[formData.toolType].map((tool) => (
        ...
        <div className="grid md:grid-cols-1 gap-3">
          <Datepicker primaryColor={'red'} value={{ startDate: formData.startDate, endDate: formData.endDate }} onChange={handleDateChange} showShortcuts={true} disabledDates={disabledDates} />
        </div>
        ...
        {/* Submit mygtukas */}
        <button type="submit" className="w-full bg-red500 text-white p-4 rounded-lg hover:bg-red-600 transition duration-300 transform hover:shadow-lg flex items-center justify-center" disabled={loading}>
