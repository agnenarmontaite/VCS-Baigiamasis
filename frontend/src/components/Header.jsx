    ...
    <header>
      <nav className="font-lexend flex items-center justify-between lg:h-[100px] bg-white p-5">
        ...
        <div className="hidden lg:flex justify-center flex-grow">
          <Link to="/" className="py-[14px] px-[20px] text-center text-black hover:text-black border border-white hover:border-red-500 hover:rounded-[25px]">
            Home
          </Link>
          <Link to="/tools" className="py-[14px] px-[20px] text-center text-black hover:text-black border border-white hover:border-red-500 hover:rounded-[25px]">
            Tools
          </Link>
          <Link to="/about" className="py-[14px] px-[20px] text-center text-black border border-white hover:text-black hover:border hover:border-red-500 hover:rounded-[25px]">
            About Us
          </Link>
          <Link to="/contact" className="py-[14px] px-[20px] text-center border border-white text-black hover:text-black hover:border hover:border-red-500 hover:rounded-[25px]">
            Contact
          </Link>
          {user ? (
          ...
          {isLoggedIn && user?.role === 'admin' && (
            <Link to="/admin" className="py-[14px] px-[20px] text-center border border-white text-black hover:text-black hover:border hover:border-red-500 hover:rounded-[25px]">
              Admin
            </Link>
          )}
        </div>
